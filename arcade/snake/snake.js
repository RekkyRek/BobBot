function SnakeJS(parentElement, config){
	...
	var defaultConfig = {
		...
		snakeColor : "#000000",			      // Color of the snake
		snakeEyeColor : "white",		      // Color of the snake's eye
		candyColor : "#267ff3",				    // Color of the candy
		shrinkingCandyColor : "#9230ef",	// Color of the special candy that shrinks
		scoreBoardColor : "#f2f2f2",		  // Color of the score board
		scoreTextColor : "#000000",			  // Color of the score numbers on the score board
	...
	function Engine(parentElement) {
      ...
      score += candy.score;
      scoreCollectAmount += 1;
			highScore = Math.max(score, highScore);
      snake.growthLeft += candy.calories;
      scoreCollectTimes.push(Date.now() - gameStarted);
      console.log(scoreCollectTimes)
		};
