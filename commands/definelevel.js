class definelevel {
  constructor (thot) {
    ...
    this.thot.register({ command: 'b!definelevel', usage: '<Minimum Score> <Role Name>', description: 'Define a role for reaching a certain amount of points.', callback: this.handle.bind(this), admin: true })
  }
